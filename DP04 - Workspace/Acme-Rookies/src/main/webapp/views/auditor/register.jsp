...
<form:form action="auditor/administrator/create.do"
	...
	<fieldset>
		<legend align="left">
			<spring:message code="auditor.edit.useraccount" />
		</legend>
		...
		<form:label path="userAccount.password">
			<spring:message code="auditor.edit.label.password" />* :
		</form:label>
	...
	<form:label path="conditionsAccepted">
		<spring:message code="auditor.conditions" />:
	</form:label>
	...
	<input type="submit" name="save"
		value="<spring:message code="auditor.edit.save" />" />&nbsp;
