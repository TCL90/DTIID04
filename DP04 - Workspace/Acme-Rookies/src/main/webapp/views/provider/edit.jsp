...
<form:form action="provider/provider/edit.do"
	...
	<fieldset>
		<legend align="left">
			<spring:message code="provider.edit.contact" />
		</legend>
		...
		<script language='javascript' type='text/javascript'>
			...
			function check(input) {
				...
				if (!(OK || OK2 || OK3)) {
					alert("<spring:message code="provider.confirm" />");
				}
			}
		</script>
		<br /> <br />
		...
		<form:label path="photo">
			<spring:message code="provider.edit.label.photo" />:
		</form:label>
	...
	<br />
	<spring:message code="provider.leave.explanation"
		var="leaveExplanation" />
	<jstl:out value="${leaveExplanation}" />

	<a href="provider/provider/show.do"> Link </a>

	<br />
	<input type="submit" name="save"
		value="<spring:message code="provider.edit.save.save" />" />&nbsp;
	<input type="submit" name="leave"
		value="<spring:message code="provider.edit.leave" />"
		onclick="return confirm('<spring:message code="provider.confirm.delete" />')" />&nbsp;
	<input type="button" name="cancel"
		onclick="javascript: window.location.replace('welcome/index.do')"
		value="<spring:message code="provider.edit.cancel" />" />
