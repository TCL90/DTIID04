...
<form:form action="provider/register.do"
	...
	<fieldset>
		<legend align="left">
			<spring:message code="provider.edit.useraccount" />
		</legend>
		...
		<form:label path="userAccount.password">
			<spring:message code="provider.edit.label.password" />* :
		</form:label>
	...
	<form:label path="conditionsAccepted">
		<spring:message code="provider.conditions" />:
	</form:label>
	...
	<input type="submit" name="save"
		value="<spring:message code="provider.edit.save" />" />&nbsp;
