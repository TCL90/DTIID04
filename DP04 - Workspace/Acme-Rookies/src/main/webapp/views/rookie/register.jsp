...
<form:form action="rookie/register.do"
	...
	<fieldset>
		<legend align="left">
			<spring:message code="rookie.edit.useraccount" />
		</legend>
		...
		<form:label path="userAccount.password">
			<spring:message code="rookie.edit.label.password" />* :
		</form:label>
	...
	<form:label path="conditionsAccepted">
		<spring:message code="rookie.conditions" />:
	</form:label>
	...
	<input type="submit" name="save"
		value="<spring:message code="rookie.edit.save" />" />&nbsp;
