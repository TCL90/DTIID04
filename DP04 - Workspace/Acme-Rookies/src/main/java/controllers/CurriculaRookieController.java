...
public class CurriculaRookieController extends AbstractController {
	...
	public ModelAndView list() {
		...
		final List<Curricula> cList = this.curriculaService.getCurriculasFromRookie();
	...
	public ModelAndView show(@RequestParam final int curriculaId) {
		...
		res.addObject("requestURI", "curricula/rookie/show.do" + "?curriculaId=" + String.valueOf(c.getId()));
